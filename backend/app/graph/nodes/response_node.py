...
from backend.app.states.agent_state import AgentState
from backend.app.core.logger import logger
from backend.app.services.ai.llm_factory import LLMFactory
from backend.app.prompts.tool_calling_prompt import TOOL_CALLING_PROMPT
from backend.app.services.ai.tool_calling_service import ToolCallingService
...
async def response_node(state: AgentState) -> AgentState:
    ...
    for iteration in range(MAX_ITERATIONS):
        ...
        if response_type == "answer":
            ...
            state.answer = parsed_response.get(
                "answer",
                "Sem resposta."
            )
