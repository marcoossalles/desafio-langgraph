...
10. If a tool result already contains enough information, generate a final_response
11. If no tool is needed, respond directly with final_response
...
{{
    "type": "final_response",
    "response": "Here are some movies similar to Interestelar..."
}}
